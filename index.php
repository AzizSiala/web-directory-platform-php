...
<body background="https://wallpaperaccess.com/full/2910358.jpg">
    <div class="container my-5">
        ...
        <a class="btn btn-outline-warning" href="create.php" role="button">Nouveau employer</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <td>$row[role]</td>
                    <td>
                        <a class='btn btn-outline-warning btn-sm' href='modifier.php?id=$row[id]'>Modifier</a>
                        <a class='btn btn-danger btn-sm' href='supprimer.php?id=$row[id]'>Archiver</a>
                    </td>
                </tr>";
                }
